...
public class NewTest extends base {
	...
	public void test2() throws IOException {
		...
		logger.log(Status.FAIL, "image below: " + logger.addScreenCaptureFromPath("/Screenshots/" + "1st" + ".png"));
	}
	...
	public void test3() throws IOException {
		...
		System.out.println(imgPath+"        =================================");
		logger.log(Status.FAIL, "image below: " + logger.addScreenCaptureFromPath("/Screenshots/" + "2nd" + ".png"));
	}
}
